/**
 * Trend Arsa — ana sayfadaki açılış (hero) ve harita bloklarının metinleri,
 * rakam şeridi ve iletişim bilgileri Supabase'de (`site_sections`,
 * `site_stats`, `site_settings`) tutuluyor ve admin panelden düzenleniyor.
 *
